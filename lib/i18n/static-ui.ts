...
const SI: StaticMap = {
  ...
  "nav.sellProduct": "නිෂ්පාදන විකිණීම",
  ...
  "search.phrase.sell": "අස්වැන්න විකිණීම...",

  "sell.title": "නිෂ්පාදන විකිණීම",

  "sell.subtitle": "ඔබේ අස්වැන්න ලැයිස්තුගත කර ගැනුම්කරුවන්ට ළඟා වන්න.",

  "sell.comingSoon": "ඉක්මනින් ලබා දෙනු ඇත",

  "sell.message":
    "AgriMind AI ගොවීන් සඳහා නිෂ්පාදන විකිණීමේ මෙවලම් අපි සකසමින් සිටී. ඔබට බෝග ලැයිස්තුගත කිරීම, මිල නියම කිරීම සහ ගැනුම්කරුවන් සම්බන්ධ කිරීම — සියල්ල එක තැනින් කළ හැකි වනු ඇත.",

  "sell.updateNote": "මෙම විශේෂාංගය අනාගත යාවත්කාලීනයකදී ලබා දෙනු ඇත. ඔබේ ඉවසීමට ස්තූතියි.",

  "sell.useMarket":
    "දැනට වෙළඪපොළ මිල බලා විකිණීමට හොඳම කාලය සැලසුම් කරන්න.",

  "sell.viewMarket": "වෙළඳපල මිල බලන්න",
...
const TA: StaticMap = {
  ...
  "nav.sellProduct": "பொருட்கள் விற்பனை",
  ...
  "search.phrase.sell": "அறுவடை விற்பனை...",

  "sell.title": "பொருட்கள் விற்பனை",

  "sell.subtitle": "உங்கள் அறுவடையை பட்டியலிட்டு வாங்குபவர்களை அடையுங்கள்.",

  "sell.comingSoon": "விரைவில் வருகிறது",

  "sell.message":
    "AgriMind AI விவசாயிகளுக்கான பொருள் விற்பனை கருவிகளை நாங்கள் தயார் செய்கிறோம். பயிர்களை பட்டியலிடுதல், விலை நிர்ணயம் மற்றும் வாங்குபவர் இணைப்பு — அனைத்தும் ஒரே இடத்தில்.",

  "sell.updateNote": "இந்த வசதி எதிர்கால புதுப்பிப்பில் வழங்கப்படும். உங்கள் பொறுமைக்கு நன்றி.",

  "sell.useMarket":
    "இப்போது சந்தை விலைகளைப் பார்த்து விற்பனைக்கு சிறந்த நேரத்தை திட்டமிடுங்கள்.",

  "sell.viewMarket": "சந்தை விலைகளைப் பார்",
